    ...
    <div class="row">
      ...
      <div class="col-md-4 text-dark">
        <div class="card border-left-info shadow ">
          <div class="card-body">
              <h5>List Pemenang</h5>
              <a href="reset2.php" class="btn btn-warning" >Reset</a>
  ...
  <script>
    $(function(){
      ...
      $('#tombol2').on('click', function(){
        ...
        const acak = setInterval(() => {
          let animasi = [1,2,3,4,5,6,7,8,9,0];
                ...
                <div class="card-body">
                  <table>
                    <tr>
                        ...
                        <td><input type="text" name="no_undian" class="form-control" value="${hasil.no_undian}"></td>
                    <tr>
                    <tr>
                        <td><label>Nama</label></td>
                        <td><input type="text" name="nama" class="form-control" value="${hasil.nama}"></td>
                    </tr>
                    <tr>
